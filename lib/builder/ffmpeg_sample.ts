...
export class FfmpegSampleBuilder extends FfmpegBuilderBase {
  ...
  public override background_cmd(background_width: number, background_height: number, total_duration?: number, background_color?: string) {
    return super.background_cmd(background_width, background_height, undefined, background_color)
  }

  public override clip(clip_builder: ClipBuilderBase) {
