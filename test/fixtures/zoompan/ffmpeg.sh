...
[1:v] setpts=PTS-STARTPTS, scale=1921:1080, crop=w=960.5:h=1080:x='if(gte(t, 10), 960.5, if(between(t, 0, 10), (n - 0)*0+960.5, 960.5))':y='0':keep_aspect=1 [v_in_1];
...
[a_in_0][a_in_1] amix=inputs=2 [audio]" \
  ...
  -map \
  [v_out_1] \
  "test/resources/ffmpeg-templates-projects/test/resources/zoompan/output.mp4" \
  -y