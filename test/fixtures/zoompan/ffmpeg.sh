...
[1:v] setpts=PTS-STARTPTS, scale=1921.8568665377175:1080, crop=w=960.9284332688587:h=1080:x='if(gte(t, 10), 960.9284332688587, if(between(t, 0, 10), (n - 0)*3.8437137330754347+0, 960.9284332688587))':y=0:keep_aspect=1 [v_in_1];
[1:a] asetpts=PTS-STARTPTS, adelay=0:all=1, volume=1[a_in_1];
[base][v_in_0] overlay=x=0:y=0:eof_action=pass [v_out_0];
[v_out_0][v_in_1] overlay=x=0:y=main_h - 1080 + 0:eof_action=pass [v_out_1];
